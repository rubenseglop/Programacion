/**
 * Clase que representa la partitura, cuya instancia almacenará los compases tocados por el músico.
 * @author 1DAMDAW
 */
public class Partitura {
	...
	/**
	 * Método encargado de almacenar una nota en el compás correspondiente. Está sujeto a sincronización.
	 * @param notaReal La nota a guardar en el compás, en formato de cadena de caracteres.
	 * @param id Identificador del hilo que intenta guardar la nota en el compás correspondiente.
	 */
	public synchronized void tocarNota(String notaReal, int id){
		// Nos bloqueamos si el compás está lleno o si no nos toca a nosotros		
	 ...
	 * @return Valor lógico indicando verdadero si el número de compases alcanzó 63 y falso en caso contrario.
	 */
	...
	/**
	 * Método que obtiene el número de compases que han sido compuestos hasta ahora.
	 ...
	 * @return El compás en forma de cadena de caracteres.
